...
/**
 * PreuAmbDescompteId generated by hbm2java
 */
public class PreuAmbDescompteId  implements java.io.Serializable {


     private String nomHotel;
     private String nomtipus;

    public PreuAmbDescompteId() {
    }

    public PreuAmbDescompteId(String nomHotel, String nomtipus) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof PreuAmbDescompteId) ) return false;
		 PreuAmbDescompteId castOther = ( PreuAmbDescompteId ) other; 
